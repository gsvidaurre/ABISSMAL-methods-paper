...
TKTK also update how we're getting the unique recording events for the indexing that happens below
...
# Iterate over all combinations of the temporl thresholds for detect_perching_events(), preprocess_detections(), and detect_clusters()
  ...
  invisible(pblapply(1:length(th_1), function(x){
    ...
    lapply(1:length(th_2), function(y){
      ...
      lapply(1:length(th_3), function(z){
        ...
        cat(paste("th_1 =", th_1[x], "; th_2 =", th_2[y], "; th_3 =", th_3[y], "\n", sep = " "))
...
files <- list.files(path, pattern = "indexed_scored_")

# TKTK need to track the values used...
