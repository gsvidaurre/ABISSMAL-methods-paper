...
- Perform the same comparison as above, but ask how reliably we captured individual identity with RFID

- How well do the timestamps agree for the first behavioral label per time unit?

- For these same time units, what is the "dominant" behavioral score based on duration, and do the methods agree on this as well?

- Is it possible to make inferences about the duration of time spent inside or outside the nest container?
